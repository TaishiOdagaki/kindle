...
**A Tool, Not a Statement, By 2013**
...
*Killing Commendatore* (騎士団長殺し), published in Japan on February 24, 2017 with an initial print run of 1.3 million copies,[^2] is a long, formally strange novel about a portrait painter and a mysterious painting come partially to life. It's an unusual book to build a chapter about real-world political controversy around, except for one thread running through it. A wealthy, enigmatic neighbor named Menshiki (免色) explains to the narrator, over the phone, the family history of another character, the painter Tomohiko Amada, whose own younger brother Tsuguhiko was conscripted and forced into direct participation in atrocities at Nanjing, and who took his own life after his discharge, unable to live with what he'd done. In the course of that explanation, the novel puts a specific line on the page about the Nanjing Massacre's death toll: some say 400,000, the text notes, others say 100,000, and then asks, in effect, what real difference that gap actually makes. It's a passage that names competing casualty estimates rather than asserting a single fixed number, built around the argument that arguing over the precise figure risks missing the actual moral weight of what happened.

**A Disputed Number, Not an Invented One**

That the massacre itself occurred is not a matter of serious dispute among mainstream historians in Japan or internationally; what remains genuinely, academically contested is the precise death toll, with published estimates ranging considerably depending on methodology and which killings and time period are counted. Both numbers the novel cites, 400,000 and 100,000, sit within that real, disputed range rather than representing invention on Murakami's part, and the passage's own rhetorical move, refusing to let the reader hide behind uncertainty over the exact count, was never going to read as a neutral piece of history to publish in Japan in 2017.

**The Reaction Split Along Predictable Lines**

The reaction split along entirely predictable lines. The Nanjing Massacre Memorial Hall in China responded through its official Weibo account with approval, quoting Murakami's own "no difference between 400,000 and 100,000" framing and noting that the postwar Nanjing War Crimes Tribunal had found more than 300,000 victims,[^3] and some Chinese commentators online went further, describing Murakami in terms amounting to a writer of conscience and integrity for naming the event at all. In Japan, the passage drew direct, public criticism from figures including novelist Naoki Hyakuta and Makoto Sakurai, the former leader of Zaitokukai, a real, documented ultranationalist organization whose name translates roughly to "citizens against special privileges for [ethnic] Koreans in Japan" and whose activity has centered on anti-Korean-resident rhetoric, with the conservative *Sankei Shimbun* also weighing in critically;[^4] contemporary coverage described mainstream Japanese news portals as carrying a substantial volume of direct criticism of the novel over the passage, not silence.

**Placed Against the Rest of This Series**

This is worth placing against everything the earlier volumes of this series have already traced. A writer whose 1979 debut was dismissed as too imitative of foreign fiction to count as serious Japanese literature, who spent the 1990s proving, through *The Wind-Up Bird Chronicle*'s Nomonhan material, that his surreal register could hold real historical weight, built a supporting character's family tragedy in a 2017 bestseller around a historical fact a meaningful share of his own domestic readership still found genuinely difficult to hear stated at all, regardless of which specific casualty figure was attached to it. It just wasn't a small thing to write down and publish under his own name, at that particular moment, in that particular country, and, at nearly seventy years old and three decades past his own literary establishment's harshest early verdicts, he did it anyway.

[^2]: *Killing Commendatore* [騎士団長殺し] was published by Shinchōsha on February 24, 2017, with an initial combined print run of 1.3 million copies.
...
**Unfinished Business in the Most Literal Sense**
...
[^5]: *The City and Its Uncertain Walls* [街とその不確かな壁] was published by Shinchōsha on April 13, 2023. Murakami began writing it in March 2020, completing the roughly 1,200-manuscript-page novel over approximately three years.
...
**A Third Kind of Engagement: The Street Level**
...
[^8]: The 14th International Murakami Haruki Symposium was held July 5–6, 2025, at Kyoto University, organized by Tamkang University's Murakami Haruki Research Center. The Haruki Murakami Library is the public name paired with Waseda University's International House of Literature.

---

## CHAPTER 7: THE OUTSIDER WHO NEVER STOPPED BEING ONE

**The Status That Kept Relocating**
...
**A Narrower Question, Answered Early**
...
**The Engine, Not Just the Origin Story**
...
**What the Reputation Actually Was**
...
- **The 400,000 / 100,000 figures** — The two competing casualty estimates for the Nanjing Massacre that *Killing Commendatore* names side by side, in a passage arguing the precise gap between them matters less than the underlying historical fact. Both sit within a genuine, disputed academic range; the massacre's occurrence itself is not seriously disputed by mainstream historians. See Chapter 2.
...
This volume draws on Murakami's own novels, on Japanese and English-language news coverage of the events and controversies discussed, and on published records from the institutions named in the text, organized here by chapter. Numbered notes in the text correspond to the sources below; this list also includes works referenced more generally that aren't tied to a single footnote.
...
- Contemporary Japanese press coverage of domestic criticism of the novel, including from Naoki Hyakuta, Makoto Sakurai, and the *Sankei Shimbun*.
