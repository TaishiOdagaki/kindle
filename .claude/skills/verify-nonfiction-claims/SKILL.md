...
- **A search result reporting a claim is not the same as the claim being confirmed.** Found while researching the *Attack on Titan* book: several sources report that a specific, politically charged real-world statement is attributed to an author via a private social media account, but every one of those sources also says the account was never officially confirmed or denied as belonging to him. The search "worked" — it surfaced real, existing discussion — but the underlying fact stayed unconfirmed. Carry the source's own hedge into the manuscript verbatim ("attributed to an account fans believe is his, never officially confirmed") rather than smoothing it into a flat statement of fact. This matters most for claims about real, living people, especially reputationally sensitive ones (political statements, allegations, scandals) — the stakes for getting the hedge wrong are higher than for a plot detail.
